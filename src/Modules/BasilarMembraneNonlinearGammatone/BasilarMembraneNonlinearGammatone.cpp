...
int BasilarMembraneNonlinearGammatone::ReadParameters(const char *ParameterFileName, const char *SectionName)
{
	...
	// boilerplate--------------------------------|  Parameter Name (in file) | Local variable | default value
    Status = theParamFile.GetParameter(SectionName, "DisableNonlinearPath", mDisableNonlinearPath, false);
