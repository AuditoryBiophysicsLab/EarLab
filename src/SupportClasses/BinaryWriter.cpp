...
void BinaryWriter::Write(const float *buf, unsigned int item_count)
{
	unsigned int i;
...
void BinaryWriter::CheckMinMax(const float *buf, unsigned int item_count)
{
	unsigned int i;
...
void BinaryWriter::OpenBinaryFile(void)
{
	...
	if (BinaryFilename == NULL)
	{
		...
		BinaryFP = OpenOutputFile(BinaryFilename, "wb");
	}
	else
		BinaryFP = OpenOutputFile(BinaryFilename, "ab");
	if (BinaryFP == NULL)
...
void BinaryWriter::OpenMetadataFile(void)
{
	...
	if (MetadataFilename == NULL)
	{
		...
		MetadataFP = OpenOutputFile(MetadataFilename, "w");
	}
	else	
		MetadataFP = OpenOutputFile(MetadataFilename, "a");
	if (MetadataFP == NULL)
