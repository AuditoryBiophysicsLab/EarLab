...
public:
	...
	inline double TemperatureFactor_2_6655(void)  {return T2_6655;} // Brughera96Compartment
	inline double TemperatureFactor_5_6569(void)  {return T5_6569;} // Brughera96Compartment

protected:
	double Temperature_DegreesC;
	double T2, T2_5, T3, T10;
	double T2_6655, T5_6569; // Brughera96Compartment
