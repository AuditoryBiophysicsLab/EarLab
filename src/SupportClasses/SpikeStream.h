...
public:
	...
	inline Spike &operator=(Spike &rhs) {CellID = rhs.CellID; SpikeTime_Seconds = rhs.SpikeTime_Seconds;};
	inline bool operator==(Spike &rhs) {return SpikeTime_Seconds == rhs.SpikeTime_Seconds;};
	inline bool operator<(Spike &rhs) {return SpikeTime_Seconds < rhs.SpikeTime_Seconds;};
	inline bool operator>(Spike &rhs) {return SpikeTime_Seconds > rhs.SpikeTime_Seconds;};
	inline bool operator<=(Spike &rhs) {return SpikeTime_Seconds <= rhs.SpikeTime_Seconds;};
	inline bool operator>=(Spike &rhs) {return SpikeTime_Seconds >= rhs.SpikeTime_Seconds;};
	inline void Swap(Spike &OtherSpike) 
	{
		Spike temp;
