#ifndef _ZL_SYNAPSE_SECOND_ORDER_H_INCLUDED
#define _ZL_SYNAPSE_SECOND_ORDER_H_INCLUDED

class ZLSynapseSecondOrder
{
public:
	ZLSynapseSecondOrder(double SampleRate_Hz, double Tau, double EPSP_strength);
