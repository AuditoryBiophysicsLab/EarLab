#ifndef _MG_SYNAPSE_SECOND_ORDER_H_INCLUDED
#define _MG_SYNAPSE_SECOND_ORDER_H_INCLUDED

class MGSynapseSecondOrder
{
public:
	MGSynapseSecondOrder(double SampleRate_Hz, double Tau, double EPSP_strength);
