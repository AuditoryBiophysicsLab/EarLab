...
{
	int i;
	double firetime = SpikeTime_Seconds; // Do comparison in same precision as stored data
...
int SpikeStream::Partition(int first, int last) 
{
#if 0
	int pivot = a[first];
	int lastS1 = first;
...
void SpikeStream::Quicksort(int first, int last) 
{
#if 0
	if (first < last) 
	{
