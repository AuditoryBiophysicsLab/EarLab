...
int AuditoryNerveSpike::ReadParameters(char *ParameterFileName)
{
	if (mModuleName == NULL)
...
int AuditoryNerveSpike::ReadParameters(char *ParameterFileName, char *SectionName)
{
...
void AuditoryNerveSpike::SetModuleName(char *ModuleName)
{
	if (mModuleName != NULL)
		delete [] mModuleName;
...
void AuditoryNerveSpike::SetLogger(Logger *TheLogger)
{
	if (mLogger != NULL)
		delete mLogger;
	mLogger = TheLogger;
