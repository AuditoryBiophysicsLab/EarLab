...
#define BUSHY_SPIKE_STEPS 100000
...
void TestBushyCell_Spike(double EPSPStrength, double IPSPStrength)
{
   ...
   //Rothman03Compartment SpikeCompartment(100000.0, -60.0e-3, 38.0);    // 38 degrees C for spike tests
...
#define BUSHY_CLAMP_STEPS 200000
...
void TestBushyCell_CurrentClamp(double CurrentClamp_Amperes)
{
	...
	//Rothman03Compartment ClampCompartment(100000.0, -60.0e-3, 22.0);	// 22 degrees C for current clamp test
