...
AppVerName=Desktop EarLab 2.1.0
...
[Files]
Source: ..\..\out\Modules\Release-Athlon\*.*; DestDir: {app}\Modules; Flags: replacesameversion ignoreversion
Source: ..\..\out\Desktop EarLab\Release-Athlon\*.*; DestDir: {app}\Desktop EarLab; Flags: replacesameversion ignoreversion
...
[Icons]
Name: {group}\Experiment Manager; Filename: {app}\Desktop EarLab\experimentmanager.exe; WorkingDir: {app}\Desktop EarLab; IconFilename: {app}\Desktop Earlab\earlab.ico; IconIndex: 0
Name: {group}\Simulator; Filename: {app}\Desktop EarLab\simulator.exe; WorkingDir: {app}\Desktop EarLab; IconFilename: {app}\Desktop Earlab\earlab.ico; IconIndex: 0
Name: {group}\Help; Filename: {app}\Desktop EarLab\DesktopEarLab.chm; WorkingDir: {app}\Desktop EarLab; IconFilename: {app}\Desktop Earlab\earlab.ico; IconIndex: 0
#ifexist "..\Documentation\readme.html"
Name: {group}\Documentation\Read Me; Filename: {app}\Desktop EarLab\readme.html; WorkingDir: {app}\Desktop EarLab
#endif
#ifexist "..\Documentation\Overview.htm"
Name: {group}\Documentation\Overview; Filename: {app}\Desktop EarLab\Overview.htm; WorkingDir: {app}\Desktop EarLab
#endif
#ifexist "..\Documentation\Experiments.pdf"
Name: {group}\Documentation\Experiment Descriptions (Requires Acrobat Reader); Filename: {app}\Desktop EarLab\Experiments.pdf; WorkingDir: {app}\Desktop EarLab
#endif
#ifexist "..\Documentation\FileGuide.htm"
Name: {group}\Documentation\File Guide; Filename: {app}\Desktop EarLab\FileGuide.htm; WorkingDir: {app}\Desktop EarLab
#endif
#ifexist "..\Documentation\InstallGuide.htm"
Name: {group}\Documentation\Installation Guide; Filename: {app}\Desktop EarLab\InstallGuide.htm; WorkingDir: {app}\Desktop EarLab
#endif
#ifexist "..\Documentation\LaunchSpikeAnalysis.bat"
Name: {group}\MATLAB Analysis Demo\Spike analysis demo (requires MATLAB); Filename: {app}\Desktop EarLab\LaunchSpikeAnalysis.bat; WorkingDir: {app}\Desktop EarLab
#endif
