...
SDT.GUI(2) = uicontrol('parent',SDT.main,...
    ...
    'style','radiobutton',...
    'value',[0],...
    'callback','global SDT;flag =get(gcbo,''value''); if flag ==1 set(SDT.GUI(3),''value'',[0]);plot_period_histogram; set(SDT.ax(3),''visible'',''on'');set(SDT.GUI([4 7]),''visible'',''on'');elseif get(SDT.GUI(3),''value'')== 0 set(SDT.ax(3),''visible'',''off'');cla;set(SDT.GUI([4 7]),''visible'',''off'');end;',...
    'Fontsize',[10],...
    'Fontname','Times New Roman',...
    'Fontweight','bold',...
...
SDT.GUI(3) = uicontrol('parent',SDT.main,...
    ...
    'callback','global SDT;flag =get(gcbo,''value''); if flag ==1 set(SDT.GUI(2),''value'',[0]);plot_ISI_histogram;set(SDT.ax(3),''visible'',''on'');set(SDT.GUI([4 7]),''visible'',''on'');elseif get(SDT.GUI(2),''value'')== 0 set(SDT.ax(3),''visible'',''off'');cla;set(SDT.GUI([4 7]),''visible'',''off'');end; ',...
...
SDT.GUI(5) =uicontrol('parent',SDT.main,...
    ...
    'tooltipstring','Load input spike files for display and analysis; temporarily disabled for demo release',...
