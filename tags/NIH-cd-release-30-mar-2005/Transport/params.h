...
int GetParameterValue(char *name, PARAM_VALUE *pval);
int GetSectionParameter(char *section, char *varname, PARAM *param);
int GetSectionParameterValue(char *section, char *varname, PARAM_VALUE *pval);

int SetParameter(PARAM *param);
int SetParameterValue(char *name, PARAM_VALUE *pval);
int SetSectionParameter(char *section, char *varname, PARAM *param);
int SetSectionParameterValue(char *section, char *varname, PARAM_VALUE *pval);
...
int SetPval(PARAM_VALUE *pval, int type, PVAL val);
