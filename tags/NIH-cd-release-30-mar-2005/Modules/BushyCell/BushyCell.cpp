			...
			unsigned long OutputElementCounts[EarlabMaxIOStreamCount])
{
	...
	//BushyCells = new Rothman93Compartment **[NumChannels];
	BushyCells = new Brughera96Compartment **[NumChannels];
	Synapses = new HHSynapse **[NumChannels];
	WasUnderThreshold = new bool *[NumChannels];

	for (Channel = 0; Channel < NumChannels; Channel++)
	{
		//BushyCells[Channel] = new Rothman93Compartment *[NumOutputReps];
		BushyCells[Channel] = new Brughera96Compartment *[NumOutputReps];
		...
		for (int OutputRep = 0; OutputRep < NumOutputReps; OutputRep++)
		{
			...
			//BushyCells[Channel][OutputRep] = new Rothman93Compartment(mSampleRate_Hz, -60.0e-3, mCellTemperature_DegreesC);
			BushyCells[Channel][OutputRep] = new Brughera96Compartment(mSampleRate_Hz, -60.0e-3, mCellTemperature_DegreesC);
