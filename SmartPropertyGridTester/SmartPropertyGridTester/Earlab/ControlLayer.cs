...
namespace EarLab
{
    ...
    class ControlLayer
    {
        ...
        public void SetInputDirectory(string InputDirectoryPath)
        {
            if (theModel == IntPtr.Zero)
                throw new ApplicationException("Model not initialized");
            ControlLayer.SetInputDirectoryExternal(theModel, InputDirectoryPath);
        }
        ...
        public int StartModules()
        {
            if (theModel == IntPtr.Zero)
                throw new ApplicationException("Model not initialized");
            return ControlLayer.StartModulesExternal(theModel);
        }
        ...
        public int AdvanceModules()
        {
            if (theModel == IntPtr.Zero)
                throw new ApplicationException("Model not initialized");
            return ControlLayer.AdvanceModulesExternal(theModel);
        }
